...
namespace SimpleMinecraftLauncher
{
    public partial class LoginForm : Form
    {
        ...
        private void btnAutoLogin_Click(object sender, EventArgs e)
        {
            ...
            var th = new Thread(() =>
            {
                ...
                if (result.Result != MLoginResult.Success)
                {
                    ...
                    Console.WriteLine($"Failed to AutoLogin : {result.Result}\n{result.ErrorMessage}");
                    Invoke(new Action(() =>
                    {
                        gMojangLogin.Enabled = true;
                        gOfflineLogin.Enabled = true;
                        gXboxLogin.Enabled = true;
                    }));
                    return;
                }
        ...
        private void btnSignoutXbox_Click(object sender, EventArgs e)
        {
            MicrosoftLoginForm loginForm = new MicrosoftLoginForm();
